...
bool TextureShaderClass::Render(ID3D11DeviceContext* deviceContext,
	int indexCount, D3DXMATRIX worldMatrix, D3DXMATRIX viewMatrix, D3DXMATRIX projectionMatrix, ID3D11ShaderResourceView* texture) {
	bool result;
...
bool TextureShaderClass::SetFliterMode(ID3D11Device* device,int i) {
	D3D11_SAMPLER_DESC samplerDesc;
	HRESULT result;
