...
bool TextClass::SetALightOn(bool bIs, ID3D11DeviceContext* deviceContext)
{
	char tempString[32];
	char numString[32];
	SentenceType *sentence;
	...
	if(bIs == true)
	 strcpy_s(numString, "AmbientLight: On");
	else
	 strcpy_s(numString, "AmbientLight: Off");
...
bool TextClass::SetDLightOn(bool bIs, ID3D11DeviceContext* deviceContext)
{
	char tempString[32];
	char numString[32];
	SentenceType *sentence;
	...
	if (bIs == true)
		strcpy_s(numString, "DiffuseLight: On");
	else
		strcpy_s(numString, "DiffuseLight: Off");
...
bool TextClass::SetSLightOn(bool bIs, ID3D11DeviceContext* deviceContext)
{
	char tempString[32];
	char numString[32];
	SentenceType *sentence;
	...
	if (bIs == true)
		strcpy_s(numString, "SpecularLight: On");
	else
		strcpy_s(numString, "SpecularLight: Off");
...
bool TextClass::SetPosition(D3DXVECTOR3 position, ID3D11DeviceContext* deviceContext)
{
	char tempString[128];
	char numString[128];
	SentenceType *sentence;
